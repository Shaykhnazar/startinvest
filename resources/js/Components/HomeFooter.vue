  ...
  <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      <div class="col-span-full hidden lg:col-span-1 lg:block">
        <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white" href="#" aria-label="Brand"><ApplicationLogo/></a>
        <p class="mt-3 text-xs sm:text-sm text-gray-600 dark:text-neutral-400">© {{ new Date().getFullYear() }} StartInvest.</p>
      </div>
      <!-- End Col -->
...
<!--          </div>-->
        ...
        <div class="flex flex-wrap justify-between items-center gap-3">
          ...
          <div class="space-x-4">
            ...
            <a href="http://www.youtube.com/@startinvest_uz" target="_blank" class="inline-block text-gray-500 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200">
