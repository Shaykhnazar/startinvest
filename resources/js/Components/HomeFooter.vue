...
<template>
  ...
  <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 my-10">
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase dark:text-neutral-100">{{ $t('site.home.footer.sections') }}</h4>
      ...
      <div>
        ...
        <div class="mt-3 grid space-y-3 text-sm">
          ...
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">
            ...
            {{ $t('site.home.footer.support') }}</a></p>
...
<!--          </div>-->
          ...
          <div class="space-x-4 text-sm">
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" :href="route('userAgreement')">{{ $t('site.home.footer.terms_of_use') }}</a>
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" :href="route('privacyPolicy')">{{ $t('site.home.footer.privacy_policy') }}</a>
            <a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:outline-none focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200" href="#">{{ $t('site.home.footer.system_status') }}</a>
          </div>
        </div>
