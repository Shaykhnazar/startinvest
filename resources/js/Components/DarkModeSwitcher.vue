...
<template>
  <button type="button" class="hs-dark-mode hs-dark-mode-active:hidden inline-flex items-center gap-x-2 py-2 px-3 bg-dark/10 rounded-full text-sm text-dark hover:bg-dark/20 focus:outline-none focus:bg-dark/20" data-hs-theme-click-value="dark">
