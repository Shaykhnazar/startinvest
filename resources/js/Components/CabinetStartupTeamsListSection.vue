...
const emit = defineEmits(['updateDisplayType'])

const switchToGrid = () => {
  emit('updateDisplayType', 'grid')
}

const switchToList = () => {
  emit('updateDisplayType', 'list')
}
</script>

<template>
  <div class="lg:p-5 space-y-4 flex flex-col lg:bg-white lg:border lg:border-gray-200 lg:shadow-sm lg:rounded-lg dark:lg:bg-neutral-800 dark:lg:border-neutral-700">
    <!-- Header -->
    <div class="flex justify-between items-center gap-x-2">
      ...
      <div class="flex justify-end items-center gap-x-2">
        <!-- Button -->
        <button type="button" @click="router.visit(route('startups.index'))" class="py-2 px-3 inline-flex items-center gap-x-1.5 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-2 focus:ring-blue-500" data-hs-overlay="#hs-pro-datm">
...
<!--          </svg>-->
        ...
        <div class="p-[3px] flex items-center bg-white border border-gray-200 rounded-lg dark:bg-neutral-800 dark:border-neutral-700">
          ...
          <a class="inline-flex shrink-0 justify-center items-center size-[30px] border-md text-gray-800 rounded-md disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:text-gray-500 dark:text-neutral-200 dark:focus:text-neutral-500  "
             href="#"
             @click="switchToGrid">
            <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="grid lg:grid-cols-12 gap-y-2 lg:gap-y-0 gap-x-4">
              <div class="lg:col-span-3">
                ...
                <div class="mt-1 lg:mt-2 -mx-0.5 sm:-mx-1">
                  ...
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Digital</span>
                </div>
                <!-- End Badge Group -->
              </div>
              <!-- End Col -->
          ...
          <div class="p-4 relative flex flex-col bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="grid lg:grid-cols-12 gap-y-2 lg:gap-y-0 gap-x-4">
              <div class="lg:col-span-3">
                ...
                <!-- Badge Group -->
                <div class="mt-1 lg:mt-2 -mx-0.5 sm:-mx-1">
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Customer service</span>
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Support</span>
                </div>
                <!-- End Badge Group -->
              </div>
              <!-- End Col -->
          ...
          <div class="p-4 relative flex flex-col bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="grid lg:grid-cols-12 gap-y-2 lg:gap-y-0 gap-x-4">
              <div class="lg:col-span-3">
                ...
                <!-- Badge Group -->
                <div class="mt-1 lg:mt-2 -mx-0.5 sm:-mx-1">
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Organizers</span>
          ...
          <div class="p-4 relative flex flex-col bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="grid lg:grid-cols-12 gap-y-2 lg:gap-y-0 gap-x-4">
              <div class="lg:col-span-3">
                ...
                <!-- Badge Group -->
                <div class="mt-1 lg:mt-2 -mx-0.5 sm:-mx-1">
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Ethereum</span>
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Cryptocurrency</span>
                </div>
                <!-- End Badge Group -->
              </div>
              <!-- End Col -->
          ...
          <div class="p-4 relative flex flex-col bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="grid lg:grid-cols-12 gap-y-2 lg:gap-y-0 gap-x-4">
              <div class="lg:col-span-3">
                ...
                <!-- Badge Group -->
                <div class="mt-1 lg:mt-2 -mx-0.5 sm:-mx-1">
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Payment</span>
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Finance</span>
                </div>
                <!-- End Badge Group -->
              </div>
              <!-- End Col -->
          ...
          <div class="p-4 relative flex flex-col bg-white border border-gray-200 rounded-xl dark:bg-neutral-800 dark:border-neutral-700">
            <div class="grid lg:grid-cols-12 gap-y-2 lg:gap-y-0 gap-x-4">
              <div class="lg:col-span-3">
                ...
                <!-- Badge Group -->
                <div class="mt-1 lg:mt-2 -mx-0.5 sm:-mx-1">
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Mailchimp</span>
                  <span class="m-0.5 sm:m-1 p-1.5 sm:p-2 inline-block bg-gray-100 text-gray-800 text-xs rounded-md dark:bg-neutral-700 dark:text-neutral-200">Subscription</span>
                </div>
                <!-- End Badge Group -->
              </div>
              <!-- End Col -->
