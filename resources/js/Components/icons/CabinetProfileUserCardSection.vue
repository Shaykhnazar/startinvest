      ...
      <nav class="flex gap-x-1">
        <a
          :class="{
            ...
            'after:bg-gray-800 text-gray-800 font-medium dark:bg-neutral-800 dark:text-white dark:after:bg-neutral-200': route().current('dashboard.public-profile')
          }" href="#" @click="visitTo(route('dashboard.public-profile'))">
          <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a :class="{
          'px-2.5 py-1.5 relative inline-flex items-center gap-x-2 hover:bg-gray-100 text-sm whitespace-nowrap rounded-lg disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-100 after:absolute after:-bottom-[11px] after:inset-x-2.5 after:z-10 after:h-0.5 after:pointer-events-none dark:text-neutral-500 dark:hover:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700': true,
          'after:bg-gray-800 text-gray-800 font-medium dark:bg-neutral-800 dark:text-white dark:after:bg-neutral-200': route().current('dashboard.teams')
        }" href="#" @click="visitTo(route('dashboard.teams'))">
          <svg class="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<!--          </span>-->
<!--        </label>-->
        <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" @click="visitTo(route('profile.edit'))" href="#">
          Tahrirlash
        </a>
      </div>
    </div>
