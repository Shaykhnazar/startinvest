...
<!--            </div>-->
        ...
        <p class="text-sm text-gray-500 dark:text-neutral-500">
          Akkauntingiz bormi?
          <a :href="route('login')" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium focus:outline-none focus:underline dark:text-blue-500">
            Kirish
