...
<template>
  <Head title="Yangi Startup Qo'shish"/>

  <CabinetLayout>
    <div style="margin: 20px 20px;">
      <dashboard-page-header :has-extra-slot="true">
        <template #content>
          <span class="text-large font-600 mr-3">Yangi Startup Qo'shish 🚀</span>
        </template>
        ...
        <el-row :gutter="20">
          <el-col :span="18" :offset="3">
            ...
            >
              ...
              <el-form-item label="Batafsil" prop="description" :class="!locked ? 'required-field' : ''">
                <text-editor ref="editorRef" :content="form.description" :editable="!locked"
