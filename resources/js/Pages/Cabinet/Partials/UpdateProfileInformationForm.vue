...
<template>
  <section>
    <header>
      <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Profil ma'lumotlari</h2>

      <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
        Hisobingizning profil ma'lumotlarini va elektron pochta manzilini yangilang.
      </p>
    </header>
